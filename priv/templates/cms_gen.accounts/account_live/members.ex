defmodule <%= web_module %>.AccountLive.Members do
  ...
  def mount(%{"id" => id}, _session, socket) do
    ...
    case Accounts.get_account(current_scope, id) do
      ...
      account ->
        ...
        Phoenix.PubSub.subscribe(<%= pubsub %>, "account:#{account.id}")
        Phoenix.PubSub.subscribe(<%= pubsub %>, "account_members:#{account.id}")
