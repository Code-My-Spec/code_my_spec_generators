defmodule <%= app_module %>.Accounts.Member do
  use Ecto.Schema
  ...
  @type t :: %__MODULE__{
          ...
          user: <%= app_module %>.Users.User.t() | Ecto.Association.NotLoaded.t(),
          account: <%= app_module %>.Accounts.Account.t() | Ecto.Association.NotLoaded.t(),
  ...
  schema "members" do
    ...
    belongs_to :user, <%= app_module %>.Users.User
    belongs_to :account, <%= app_module %>.Accounts.Account, type: :binary_id
