defmodule <%= app_module %>.Accounts.Account do
  use Ecto.Schema
  ...
  @type t :: %__MODULE__{
          ...
          name: String.t(),
          slug: String.t() | nil,
          members: [<%= app_module %>.Accounts.Member.t()] | Ecto.Association.NotLoaded.t(),
          users: [<%= app_module %>.Users.User.t()] | Ecto.Association.NotLoaded.t(),
  ...
  schema "accounts" do
    ...
    has_many :members, <%= app_module %>.Accounts.Member, on_delete: :delete_all
